...
function SignUpLogIn() {
    ...
    if (user) {
        ...
        return (
            <div>
                <div className="icons chat"><i className="bi bi-chat-dots"></i></div>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', flexDirection: 'column' }}>
                    ...
                    <div className="form-container">
                        ...
                        <form className="form" onSubmit={SignVerif}>
                        ...
                        <div class="social-message">
                            <div class="line"></div>
                            <p class="message1">Login with social accounts</p>
                            <div class="line"></div>
                        </div>
                        <div class="social-icons">
                            <button aria-label="Log in with Google" class="icon" >
                                <svg xmlns="http://www.w3.org/2000/svg" style={{ cursor: 'pointer' }} viewBox="0 0 32 32" class="w-5 h-5 fill-current">
                                    <path
                        ...
                        </div>          <p className="signup">Don't have an account? <Link to="/SignUp" className="" style={{ cursor: 'pointer' }}>Sign up</Link></p>
                    </div>
                </div>
